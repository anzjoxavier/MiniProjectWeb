      ...
      body: Stack(
        children:[ 
          SizedBox(
            ...
            child: Image.network("assets/background.png",fit: BoxFit.fill,),
          ),
                ...
                blurRadius: 5) //blur radius of shadow
                  ...
                  child: Padding(
                    ...
                    child: DropdownButton(
                      ...
                      dropdownColor: const Color.fromARGB(255, 251, 0, 125).withOpacity(0.75),
                      isExpanded: true,
                      value: dropdownvalue,
                      underline: Container(), 
                      ...
                      items: items.map((String items) {
                        return DropdownMenuItem(
                          value: items,
                          child: Center(child: Text(items,style:const TextStyle(color: Colors.white,fontWeight: FontWeight.w700),)),
                        );
                      }).toList(),
